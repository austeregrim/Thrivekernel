...
static const int core_millivolts[MAX_DVFS_FREQS] =
	{950, 1000, 1100, 1225, 1275, 1275, 1350};
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	{725, 750, 800, 900, 975, 1000, 1050, 1100, 1200, 1275, 1300, 1325, 1450, 1450};
...
static struct dvfs_rail tegra2_dvfs_rail_vdd_cpu = {
	...
	.min_millivolts = 725,
	.nominal_millivolts = 1550, //1125
};

static struct dvfs_rail tegra2_dvfs_rail_vdd_core = {
	.reg_id = "vdd_core",
	.max_millivolts = 1600, //1300
	.min_millivolts = 950,
	.nominal_millivolts = 1525, //1225
...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 216, 312, 456, 608, 760,  816,  912,  1000, 1232, 1336, 1424, 1472, 1544, 1592),
	CPU_DVFS("cpu", 1, 1, MHZ, 216, 312, 456, 608, 760,  816,  912,  1000, 1232, 1336, 1424, 1472, 1544, 1592),
	CPU_DVFS("cpu", 1, 2, MHZ, 816, 912, 1000, 1232, 1336, 1424, 1472, 1544, 1592),
	CPU_DVFS("cpu", 1, 3, MHZ, 912, 1000, 1232, 1336, 1424, 1472, 1544, 1592),
	...
	CORE_DVFS("epp",     -1, 1, KHZ, 133000, 171000, 247000, 425000, 425000, 425000, 425000),
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 425000, 425000, 425000, 425000),

	CORE_DVFS("3d",       0, 1, KHZ, 247000, 285000, 351500, 425000, 425000, 425000, 425000),
	CORE_DVFS("3d",       1, 1, KHZ, 247000, 285000, 351500, 425000, 425000, 425000, 425000),
	CORE_DVFS("3d",       2, 1, KHZ, 247000, 285000, 351500, 425000, 425000, 425000, 425000),
	CORE_DVFS("3d",       3, 1, KHZ, 247000, 285000, 351500, 425000, 425000, 425000, 425000),

	CORE_DVFS("mpe",      0, 1, KHZ, 104500, 152000, 228000, 425000, 425000, 425000, 425000),
	CORE_DVFS("mpe",      1, 1, KHZ, 142500, 190000, 275500, 425000, 425000, 425000, 425000),
	CORE_DVFS("mpe",      2, 1, KHZ, 190000, 237500, 300000, 425000, 425000, 425000, 425000),
	CORE_DVFS("mpe",      3, 1, KHZ, 228000, 266000, 300000, 425000, 425000, 425000, 425000),
