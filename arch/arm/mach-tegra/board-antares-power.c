...
static struct regulator_init_data sm0_data = REGULATOR_INIT(sm0, 600, 1600, ON, NULL);
static struct regulator_init_data sm1_data = REGULATOR_INIT(sm1, 600, 1550, ON, &sm1_config);
