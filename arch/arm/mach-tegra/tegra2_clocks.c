...
struct clk tegra_list_periph_clks[] = {
	...
	PERIPH_CLK("vfir",	"vfir",			NULL,	7,	0x168,	0x31E,	73000000,  mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	...
	PERIPH_CLK("vcp",	"tegra-avp",		"vcp",	29,	0,	0x31E,	315000000, mux_clk_m, 			0),
	PERIPH_CLK("bsea",	"tegra-avp",		"bsea",	62,	0,	0x31E,	315000000, mux_clk_m, 			0),
	PERIPH_CLK("bsev",	"tegra-aes",		"bsev",	63,	0,	0x31E,  300000000, mux_clk_m, 			0),
	PERIPH_CLK("vde",	"tegra-avp",		"vde",	61,	0x1c8,	0x31E,	315000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71), /* scales with voltage and process_id */
	...
	PERIPH_CLK("host1x",	"host1x",		NULL,	28,	0x180,	0x31E,	170000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
...
static struct tegra_sku_rate_limit sku_limits[] =
{
	...
	RATE_LIMIT("host1x",	190000000, 0x0F),
	...
	RATE_LIMIT("pclk",	200000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
