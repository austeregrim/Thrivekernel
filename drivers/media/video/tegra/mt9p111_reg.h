...
#define MT9P111_POLL_RETRIES            500
#define MT9P111_COLOR_EFFECT_MASK       0xFF
#define MT9P111_EXPOSURE_SHIFT          0x10
#define MT9P111_EXPOSURE_MASK           0xF
...
enum {
	...
	MT9P111_EXPOSURE_MINUS_1 = 15,
	MT9P111_EXPOSURE_MINUS_2 = 14
};
...
{MT9P111_REG16, 0x098E, 0x1000},	/* LOGICAL_ADD */
...
{MT9P111_REG8, 0x8404, 0x06},		/* SEQ_CMD */
{MT9P111_POLL8, 0x8404, 0x00},
{MT9P111_REG16, 0x0620, 0x8000},	/* VCM_CONTROL */
{MT9P111_TABLE_END, 0, 0}
};

static struct mt9p111_reg focus_infinity[] = {
{MT9P111_REG16, 0x098E, 0x1000},	/* LOGICAL_ADDRESS_ACCESS [SEQ_STATE_CFG_1_AF] */
...
{MT9P111_REG8, 0xB013, 0x55},		/* AF_FS_NUM_STEPS2 */
{MT9P111_REG8, 0xB014, 0x04},		/* AF_FS_STEP_SIZE */
{MT9P111_REG8, 0xB018, 0x50},		/* AF_FS_POS_0 */
{MT9P111_REG8, 0xB019, 0x54},		/* AF_FS_POS_1 */
{MT9P111_REG8, 0xB01A, 0x58},		/* AF_FS_POS_2 */
{MT9P111_REG8, 0xB01B, 0x5C},		/* AF_FS_POS_3 */
